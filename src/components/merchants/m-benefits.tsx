...
const MBenefits = () => {
  return (
    <div className="w-full -mt-10 h-fit xs:px-[25px] sm:px-[50px] md:px-[75px] lg:px-[75px] xl:px-[150px] pt-[75px] pb-[100px] bg-white rounded-tl-[40px] rounded-tr-[40px] flex-col justify-center items-center gap-[30px] inline-flex">
